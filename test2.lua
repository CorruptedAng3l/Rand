--[[
    ...
    - Utility.AddDrag() - Performance optimization
    - Utility.OnMouse() - Performance optimization
    - Utility.AddDrawing() - Performance optimization
    - Utility.RemoveDrawing() - Performance optimization
    - Utility.AddCursor() - Performance optimization
    - Utility.Round() - Enhanced logic
    - Utility.MiddlePos() - Optimized calculation
    - Library.SelfDestruct() - Improved cleanup
...
do
    ...
    Utility.AddDrawing = function(Instance, Properties, Location)
        ...
        -- Set default Thickness for shapes to avoid executor errors
        if InstanceType == "Square" or InstanceType == "Line" or InstanceType == "Triangle" or InstanceType == "Quad" then
